  ...
  return $.fn.reportCard = function(options) {
    ...
    ReportCard = (function() {
      ...
      ReportCard.prototype.build = function(data) {
        ...
        html = "<p>I have passed " + data.badge_count + " lessons and scored " + (toThousands(data.points_total)) + " points at " + data.site + "!<br />Check out some of my last passed course content at the badges below: </p>\n<ul class=\"badges\">";
